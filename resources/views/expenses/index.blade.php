    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">المصروفات
                ...
                <a href="{{ action('ExpensesController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">اضافة جديد</a>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">اجمالي المصروفات</small>
            </h1>
            @endpermission
            @endpermission
        </div><!-- / PageHead -->
                            ...
                            <div class="row">
                                <div class="col-sm-12 no-padding">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        {!! Form::label('expense-daterangepicker','التاريخ') !!}
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        {!! Form::label('category_id','قسم المصروفات') !!}
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        {!! Form::select('sort_field',array('created_at' => 'التاريخ','name' => 'الاسم','amount' => 'المبلغ','due_date' => 'تاريخ الاستحقاق','category_name' => 'قسم المصروفات'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                    </div>
                        ...
                        <div class="panel-body bg-white">
                            ...
                            @else
                                <table id="expenses" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th class="text-center">اسم المصروفات</th>
                                        <th class="text-center">قسم المصروفات</th>
