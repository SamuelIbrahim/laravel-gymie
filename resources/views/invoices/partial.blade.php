    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">الفواتير
                <small>بيانات الفواتير المدفوعة جزئيا</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">الفواتير المدفوعة جزئيا</small>
            </h1>
            @endpermission
        </div><!-- / PageHead -->
                            ...
                            @else
                                ...
                                <table id="invoices" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>الخصم</th>
                                        <th>تاريخ الانشاء</th>
                                        <th class="text-center">غمليات</th>
                                    </tr>
                                    </thead>
                                    <tbody>
