                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            {!! Form::select('sort_field',array('created_at' => 'التاريخ','invoice_number' => 'رقم الفاتورة','member_name' => 'اسم العضو','total' => 'اجمالي المبلغ','pending_amount' => 'المتبقي'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                                        </div>
